...
<html>
  <head>
      <title>Extract Product Content (Library) | Datawords</title>
      <meta charset="UTF-8" />
  ...
  <body>
    ...
    <div class="contents" id="spprtd">
      ...
      <div id="app">
        ...
        <h1 class="neons">Extract Product Content (Library)</h1>
        <form name="page-designer-library" id="form-pd">
          ...
          <div>
            <label for="pageids-textarea"
              >Product IDs (comma separated values):</label
            >
            <textarea
              name="pageids"
              id="pageids-textarea"
    ...
    <!-- END OF BACK GROUND-->
    <script src="js/product-content-library.js"></script>
